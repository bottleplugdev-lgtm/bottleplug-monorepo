      ...
      <div class="card">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-red-600">UGX {{ financialSummary.totalExpenses.toLocaleString() }}</p>
      ...
      <div class="card">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-primary-600">UGX {{ financialSummary.monthlySpend.toLocaleString() }}</p>
          ...
          <div class="h-12 w-12 bg-primary-100 rounded-lg flex items-center justify-center">
            <BarChart3 class="h-6 w-6 text-primary-600" />
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-2xl font-bold text-secondary-800">UGX {{ financialSummary.avgExpense.toLocaleString() }}</p>
          ...
          <div class="h-12 w-12 bg-secondary-100 rounded-lg flex items-center justify-center">
            <Percent class="h-6 w-6 text-secondary-600" />
          </div>
        </div>
      </div>
    </div>
